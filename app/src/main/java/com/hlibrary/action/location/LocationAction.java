...
import com.hlibrary.action.BaseLocationAction;
 ...
 * 百度地图离线定位
 */
public class LocationAction extends BaseLocationAction implements BDLocationListener {
    ...
    public void onReceiveLocation(BDLocation location) {
        ...
        if (fitResult) {
            if (!"".equals(location.getAddrStr()) || location.getAddrStr() != null) {
                if (isLocationOnce())
                    locationStop();
                LocationVo locationVo = new LocationVo();
                locationVo.setAddr(location.getAddrStr());
